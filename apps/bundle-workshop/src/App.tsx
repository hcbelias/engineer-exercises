    ...
    >
      <header style={{ marginBottom: 8 }}>
        ...
        <p style={{ fontSize: 13, color: "#6b7280", margin: "0 0 20px" }}>
          Run <code style={{ background: "#f3f4f6", padding: "1px 5px", borderRadius: 3 }}>pnpm build</code> then open{" "}
          <code style={{ background: "#f3f4f6", padding: "1px 5px", borderRadius: 3 }}>dist/stats.html</code> to visualise
          the bundle. Fix the four BUNDLE ISSUEs and rebuild to see the chunks shrink.
        </p>
      </header>
