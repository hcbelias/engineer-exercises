  ...
  return (
    <div>
      ...
      <p style={{ color: "#6b7280", marginBottom: 16 }}>
        10,000 users — only the visible rows should be in the DOM at any time. Open React DevTools
        Profiler to measure the difference before and after virtualization.
      </p>
